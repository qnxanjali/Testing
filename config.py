...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/qnxanjali/Testing")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "Master")
GIT_TOKEN = getenv("GIT_TOKEN", None)

# ❖ SUPPORT AND CONTACT INFORMATION - PROVIDE YOUR OWN SUPPORT CHANNELS 
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/THE_IAS_VISION")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+n9oxbrpBBqE5NjY1")
