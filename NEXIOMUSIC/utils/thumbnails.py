...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("NEXIOMUSIC/assets/SAPNA/font2.ttf", 30)
    font = ImageFont.truetype("NEXIOMUSIC/assets/SAPNA/font.ttf", 30)
    title_font = ImageFont.truetype("NEXIOMUSIC/assets/SAPNA/font3.ttf", 45)
    ...
    play_icons = Image.open("NEXIOMUSIC/assets/SAPNA/play_icons.png")
